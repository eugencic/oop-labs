...
public class Task3 {
    public static double average(University university) {
        double sum = 0;
    ...
    public static void main(String[] args) {
        ...
        double average1 = average(university1);
        ...
        double average2 = average(university2);
        ...
        double average3 = average(university3);
